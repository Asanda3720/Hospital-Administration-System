<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administration.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Analysis.Administration" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administration Dashboard - MediConnect</title>
    <!-- Bootstrap CSS -->
                            ...
                            <%
                                ...
                                if (userCookieRetriever != null)
                                {
                                    if (userCookieRetriever["userType"] == "0")
                                    {
                                       ...
                                       Response.Write("<li class='nav-item'><a class='nav-link active' href='/Web_Forms/Analysis/Administration.aspx'>ADMIN</a></li>");
                                    }
                                }
...
%>
    ...
    <main class="admin-container">
        <h1 class="admin-title">Hospital Administration Dashboard</h1>
        ...
        <form id="form1" runat="server">
            ...
            <div class="filter-control">
                <label for="drdAppStatus">Filter by Status:</label>
                <asp:DropDownList ID="drdAppStatus" runat="server" CssClass="dropdown-list" AutoPostBack="True" OnSelectedIndexChanged="drdAppStatus_SelectedIndexChanged">
            ...
            <h2 class="section-title">Ordered Meals</h2>
            <div class="gridview-container">
                <asp:GridView ID="GridView2" runat="server" CssClass="gridview"></asp:GridView>
            </div>
            
            <h2 class="section-title">Booked XRAY Scans</h2>
            <div class="gridview-container">
                <asp:GridView ID="GridView4" runat="server" CssClass="gridview"></asp:GridView>
            </div>
            
            <h2 class="section-title">Prescribed Medication</h2>
            <div class="gridview-container">
                <asp:GridView ID="GridView5" runat="server" CssClass="gridview"></asp:GridView>
            </div>
        </form>
    </main>
