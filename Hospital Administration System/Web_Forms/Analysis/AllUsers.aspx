<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllUsers.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Analysis.AllUsers" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>User Management - MediConnect</title>
    <!-- Bootstrap CSS -->
                            ...
                            <a class="nav-link" href="/Web_Forms/Doctors.aspx">DOCTORS</a>
                                ...
                                if (userCookieRetriever != null)
                                {
                                    if (userCookieRetriever["userType"] == "0")
                                    {
                                       ...
                                       Response.Write("<li class='nav-item'><a class='nav-link active' href='/Web_Forms/Analysis/AllUsers.aspx'>View USERS</a></li>");
                                    }
                                }
...
%>
    ...
    <div class="users-container">
        <h1 class="users-title">Manage <span>Users</span></h1>
