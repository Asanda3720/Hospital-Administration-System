<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddLabResults.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Lab.AddLabResults" %>
...
%>
    ...
    <div class="xray-container">
        <h1 class="xray-title">&nbsp;Lab Results<span> </span></h1>
        ...
        <form id="form1" runat="server">
            ...
            <div class="button-group">
                ...
                <asp:Button ID="btnUpdateReport" runat="server" Text="Add Lab Results" CssClass="btn btn-primary" OnClick="btnUpdateReport_Click" />
            </div>
        </form>
    </div>
