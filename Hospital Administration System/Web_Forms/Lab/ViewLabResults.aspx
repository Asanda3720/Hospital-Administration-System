<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewLabResults.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Lab.ViewLabResults" %>
...
%>
    ...
    <div class="report-container">
        <h1 class="report-title">View Lab Results</h1>
        ...
        <form id="form1" runat="server">
            ...
            <asp:Button ID="btnEdit" runat="server" Text="Edit Results" CssClass="btn-edit" OnClick="btnEdit_Click" Visible="False" />
        </form>
    </div>
    <div>
        <br />
