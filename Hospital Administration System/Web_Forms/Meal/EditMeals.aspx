<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMeals.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Meal.EditMeals" %>
...
<li class="nav-item">
    ...
    <div class="meal-container">
        <h1 class="meal-title">Update Your <span>Meals</span></h1>
        ...
        <form id="form1" runat="server">
            ...
            <asp:Button ID="btnConfirm" runat="server" Text="Update Meals" CssClass="btn-order" OnClick="btnConfirm_Click" />
        </form>
    </div>
