<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YourMeals.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Meal.YourMeals" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Your Meals - MediConnect</title>
    <!-- Bootstrap CSS -->
...
<li class="nav-item">
    ...
    <main class="main-content">
        <div class="meals-container">
            <h1 class="meals-title">Your <span>Meals</span></h1>
            ...
            <form id="form1" runat="server">
                ...
                <div class="button-group">
                    ...
                    <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="Change your meals" CssClass="btn btn-primary" />
                </div>
            </form>
        </div>
    </main>
