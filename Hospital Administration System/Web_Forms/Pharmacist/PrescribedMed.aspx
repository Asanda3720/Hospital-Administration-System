<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrescribedMed.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Pharmacist.PrescribedMed" %>
    ...
    <a class="nav-link" href="/Web_Forms/Doctors.aspx">DOCTORS</a>
                                ...
                                if (userCookieRetriever != null)
                                {
                                    if (userCookieRetriever["userType"] == "6")
                                    {
                                       ...
                                       Response.Write("<li class='nav-item'><a class='nav-link active' href='/Web_Forms/Pharmacist/PrescribedMed.aspx'> PRESCRIBED MED</a></li>");
                                    }
                                }
...
%>
    ...
    <div class="patients-container">
        <h1 class="patients-title">All Prescribed Medication</h1>
