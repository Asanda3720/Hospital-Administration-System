<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Account.ForgotPassword" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Reset Password - MediConnect</title>
    <!-- Bootstrap CSS -->
...
<li class="nav-item">
    <a class="nav-link" href="/Web_Forms/Doctors.aspx">DOCTORS</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/Web_Forms/Login.aspx">LOGIN</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <form id="form1" runat="server">
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="TextBox1"
                    CssClass="text-danger" ErrorMessage="Email is required" Display="Dynamic" ID="RequiredFieldValidator3" />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="TextBox1"
                    ...
                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic" ID="RegularExpressionValidator2" />
            </div>
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="TextBox2"
                    CssClass="text-danger" ErrorMessage="Password is required" Display="Dynamic" ID="RequiredFieldValidator1" />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="TextBox2"
                    ...
                    Display="Dynamic" ID="RegularExpressionValidator1" />
            </div>
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="TextBox3"
                    CssClass="text-danger" ErrorMessage="Password is required" Display="Dynamic" ID="RequiredFieldValidator2" />
                <asp:Label ID="lblMatch" runat="server" CssClass="text-danger" Text="Passwords do not match!" Visible="False"></asp:Label>
            </div>
            
            <asp:Button ID="Button1" runat="server" Text="Reset Password" CssClass="btn-reset" OnClick="Button1_Click" />
        </form>
    </div>
