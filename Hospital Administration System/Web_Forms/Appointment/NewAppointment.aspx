<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewAppointment.aspx.cs" 
    Inherits="Hospital_Administration_System.Web_Forms.Appointment.NewAppointment" %>
                    ...
                    <div class="card shadow-sm" style="left: 0px; top: 0px">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <br />
                                        <asp:DropDownList ID="drdAppCategory" runat="server" CssClass="form-control">
                                            <asp:ListItem Selected="True">Initial Consultation</asp:ListItem>
                                            <asp:ListItem>Follow-Up</asp:ListItem>
                                            <asp:ListItem>Routine Check-up</asp:ListItem>
                                            <asp:ListItem>Emergency Appointment</asp:ListItem>
                                            <asp:ListItem>Health Assessment</asp:ListItem>
                                        </asp:DropDownList>
                                        <br />
                                        <br />
                                        <label for="txtName">Doctor Speciality:</label><br />
                                        <asp:DropDownList ID="drdDocSpeciality" runat="server" CssClass="form-control">
                                            <asp:ListItem Selected="True">Cardiologist</asp:ListItem>
                                        ...
                                        <br />
                                        <br />
                                        <label for="txtName"></label><asp:TextBox ID="txtName1" runat="server" CssClass="form-control" placeholder="Dentist" Enabled="False" Visible="False"></asp:TextBox>
                                        <label for="txtName">Appointment Date: </label>
                                        <asp:Label ID="lblErrorDate" runat="server" ForeColor="Red" Text="Choose a valid date!" Visible="False"></asp:Label>
                                        <br />
                                        <asp:Calendar ID="calAppDate" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="190px" NextPrevFormat="FullMonth" Width="350px">
                            ...
                            <div class="m-t-20 text-end">
                                <asp:Button ID="btnSubmit" runat="server" Text="Create New Appointment" 
