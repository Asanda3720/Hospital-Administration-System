<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewXRayReport.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.XRAY.ViewXRayReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View X-Ray Report - MediConnect</title>
    <!-- Bootstrap CSS -->
...
<li class="nav-item">
    ...
    <div class="report-container">
        <h1 class="report-title">View <span>X-Ray Report</span></h1>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Body_Part" HeaderText="Body Part" />
        <asp:TemplateField HeaderText="X-Ray Image">
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" 
                    ImageUrl='<%# Eval("Image") != DBNull.Value ? "data:image/jpeg;base64," + Convert.ToBase64String((byte[])Eval("Image")) : "" %>'
                    Width="150" 
                    Visible='<%# Eval("Image") != DBNull.Value %>' />
                <asp:Label ID="lblNoImage" runat="server" Text="No Image Available" 
                    Visible='<%# Eval("Image") == DBNull.Value %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
    <HeaderStyle CssClass="grid-header" />
    ...
    <PagerStyle CssClass="pager" />
            ...
            <asp:Button ID="btnEdit" runat="server" Text="Edit Report" CssClass="btn-edit" OnClick="btnEdit_Click" Visible="False" />
        </form>
    </div>
    <div>
        <br />
