<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditXRayReport.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.XRAY.EditXRayReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit X-Ray Report - MediConnect</title>
    <!-- Bootstrap CSS -->
...
<li class="nav-item">
    ...
    <div class="xray-container">
        <h1 class="xray-title">Edit <span>X-Ray Report</span></h1>
        
        <form id="form1" runat="server">
                        <div class="form-group">
    <label for="TextBox1">Body Part to Scan:</label>
                            <asp:Panel ID="Panel1" runat="server" Height="250px" Width="250px">
                                <asp:Image ID="imgItem" runat="server" Width="250px" Height="250px" />
                            </asp:Panel>
    <br />
</div>
            <div class="form-group">
    ...
    <br />
             ...
             <div class="form-group">
     <label for="TextBox9">Add Image:</label>
                 <asp:FileUpload ID="fileUploadImage" runat="server" CssClass="form-control" />
     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox9" ErrorMessage="Required!" ForeColor="Red" Enabled="False"></asp:RequiredFieldValidator>
     <br />
 </div>
            <div class="form-group">
            ...
            <div class="button-group">
                ...
                <asp:Button ID="btnUpdateReport" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btnUpdateReport_Click" />
            </div>
        </form>
    </div>
