<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Billings.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Payment.Billings" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Billings - MediConnect</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="billing-container">
        <h1 class="billing-title">Your <span>Outstanding Payments</span></h1>
        
        <form id="form1" runat="server">
            <div>
                <asp:Label ID="lblNoOutstanding" runat="server" Text="No Outstanding Payments!" CssClass="no-payments" Font-Bold="True" Font-Italic="True"></asp:Label>
            </div>
            <asp:GridView ID="GridView1" runat="server" CssClass="gridview">
            </asp:GridView>
            <div class="total-amount">
                Total Amount: <asp:Label ID="lblAmount" runat="server" Text="R0.00" Font-Bold="True" Font-Underline="True"></asp:Label>
            </div>
            <p>
                <asp:Button ID="btnPayment" runat="server" OnClick="btnPayment_Click" Text="Settle Payment" CssClass="btn-payment" />
            </p>
        </form>
    </div>
