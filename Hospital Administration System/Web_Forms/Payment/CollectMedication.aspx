<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectMedication.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Payment.CollectMedication" %>
...
%>
    ...
    <main class="confirmation-container">
        ...
        <h1 class="confirmation-title">Your Medication</h1>
        <p class="confirmation-message">Below is the medication prescribed to you:</p>
        ...
        <form id="form1" runat="server">
            ...
            <asp:Button ID="btnDownload" runat="server" Text="Collect Now" CssClass="btn-download" OnClick="btnDownload_Click" />
