<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Hospital_Administration_System.Web_Forms.Register" %>
    ...
    <div class="top-info-bar">
        <div class="container">
            <div class="top-info-content">
                ...
                <a href="/Web_Forms/Login.aspx" class="login-link"><i class="fas fa-user"></i> Login</a>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="auth__section">
                ...
                <div class="auth__header">
                    <p class="auth__page__title">Create Your Account</p>
                ...
                <form id="form1" runat="server" role="form">
                    ...
                    <div class="form-group">
                        <label for="txtUsername">Gender</label>
                        <div class="input">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input">
                                    ...
                                    <asp:TextBox runat="server" ID="txtbxPassword" TextMode="Password" 
                                        CssClass="form-control" placeholder="Create password" />
                                </div>
                                ...
                                <asp:RegularExpressionValidator runat="server" ControlToValidate="txtbxPassword"
                                    CssClass="text-danger" 
                                    ErrorMessage="Password must be at least 8 characters long, contain one uppercase letter, one special character, and one numeric value." 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="txtbxPassword1">Confirm Password</label>
                                <div class="input">
                                    <i class="fas fa-lock"></i>
                                    <asp:TextBox runat="server" ID="txtbxPassword1" TextMode="Password" 
                                        CssClass="form-control" placeholder="Confirm password" />
                                </div>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtbxPassword1"
                                    CssClass="text-danger" ErrorMessage="Please confirm your password" Display="Dynamic" />
                                <asp:CompareValidator runat="server" ControlToCompare="txtbxPassword" 
                                    ControlToValidate="txtbxPassword1" CssClass="text-danger" Display="Dynamic"
                                    ErrorMessage="Passwords do not match" />
                                <asp:Label ID="lblMatch" runat="server" CssClass="text-danger" Text="Passwords do not match!" Visible="False"></asp:Label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center mt-4">
                        ...
                        <asp:Button ID="btnLogin0" runat="server" CssClass="btn btn-secondary ms-3" 
                            Text="Already Have an Account?" OnClick="btnLogin0_Click" CausesValidation="False" />
                    </div>
                </form>
                
                <div class="section__separator"></div>
                <p class="useful-links">Already have an account? <a href="Login.aspx" class="text-primary">Sign In</a></p>
            </div>
        </div>
    </div>
